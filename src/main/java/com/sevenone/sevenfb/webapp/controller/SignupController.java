...
import com.sevenone.sevenfb.service.UserExistsException;
...
public class SignupController extends BaseFormController {
    ...
    public User showForm(WebRequest request) {
    ...
    public String onSubmit(final User user, final BindingResult errors, final HttpServletRequest request, final HttpServletResponse response, WebRequest wrequest)
            throws Exception {
        ...
        try {
            ...
            providerSignInUtils.doPostSignUp(user.getUsername(),wrequest);
