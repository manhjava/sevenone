...
public class BaseFormController implements ServletContextAware {
	...
	@Autowired
	public void setTeamManager(TeamManager teamM) {
		this.teamManager = teamM;
	}
	...
	public User getCurrentUser() {
		...
		return getUserManager().getUserByUsername(current);
	}
	
	/*public User getUserTeam() {
		Authentication auth = SecurityContextHolder.getContext().getAuthentication();
		String current = auth.getName();
		return getUserManager().getUserWithTeam(current);
	}*/
