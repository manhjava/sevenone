 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.sevenone.sevenfb.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
	...
	public User getUserWithTeam(String username) {
		return (User) userDao.getUserWithTeam(username);
	}
