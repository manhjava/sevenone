...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see org.appfuse.service.impl.PasswordTokenManager#generateRecoveryToken(com.sevenone.sevenfb.model.User)
     */
    @Override
    ...
    /**
     * @see org.appfuse.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.sevenone.sevenfb.model.User, java.lang.String)
     */
    @Override
